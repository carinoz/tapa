							...
							for (var prod_item in result_item)
							{
								...
								if(x == 1)
								{
									...
									else
									{
										...
										prod_display.push('<li><a id="'+result_item[prod_item].ProductUUID.toString()+'" class="open-popup-link" href="#popup-product"><img border:1px solid #694306; width="120px" height="120px"  src="http://tapas.ifabula.com/'+result_item[prod_item].image_thumbnail.toString()+'"/>');	
